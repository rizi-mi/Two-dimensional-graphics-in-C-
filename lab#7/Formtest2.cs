...
namespace Graphics_with_C
{
    public partial class Formtest2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                // Рисуем контур домика
                Pen pen = new Pen(Color.Black, 2);
                g.DrawLine(pen, 100, 200, 300, 200);
                g.DrawLine(pen, 100, 200, 200, 100);
                g.DrawLine(pen, 300, 200, 200, 100);
                g.DrawRectangle(pen, 100, 200, 200, 200);

                // Рисуем контур окон и двери
                g.DrawRectangle(pen, 120, 250, 50, 50);
                g.DrawRectangle(pen, 230, 250, 50, 50);
                g.DrawRectangle(pen, 175, 320, 50, 80);
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (Graphics g = this.CreateGraphics())
            {
                // Закрашиваем домик цветом fillColor
                SolidBrush brush = new SolidBrush(fillColor);
                g.FillRectangle(brush, 101, 201, 199, 199);
